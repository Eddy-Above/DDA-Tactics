...
Rank 2 (requires Agility Rank 2): After Agility triggers (both ranks), must reroll all successful Dodge dice, take second result.`,
  ...
  // === DIGIZOID ARMOR (Section 3.12a) ===
  {
    ...
    prerequisites: [],
    stageRequirement: 'ultimate',
    description: 'Choose a Digizoid Armor type. Can only take one.',
    effect: `Choose one Digizoid Armor variant to enhance your Digimon's defenses.`,
    choices: [
      {
        id: 'chrome',
        name: 'Chrome',
  ...
  // === DIGIZOID WEAPONRY (Section 3.12b) ===
  {
    ...
    stageRequirement: 'ultimate',
    description: 'Choose a Digizoid Weaponry type. Can only take one.',
    effect: `Choose one Digizoid Weaponry variant to enhance your Digimon's [Weapon] attacks.`,
    choices: [
      { id: 'chrome', name: 'Chrome', dpCost: 1, stageRequirement: 'ultimate', effect: `[Weapon] attacks gain +2 Accuracy, +1 Damage.` },
      { id: 'black', name: 'Black', dpCost: 2, stageRequirement: 'mega', effect: `[Weapon] attacks gain +2 Accuracy. Each round roll 1d6: 1-2: +4 Damage; 3-4: +4 Accuracy; 5-6: +2 Damage and +2 Accuracy.` },
      { id: 'brown', name: 'Brown', dpCost: 3, stageRequirement: 'mega', effect: `+2 Dodge. [Weapon] attacks gain +2 Damage and 2 ranks of Reach.` },
      { id: 'blue', name: 'Blue', dpCost: 3, stageRequirement: 'mega', effect: `[Weapon] attacks gain +2 Accuracy, +2 Damage, and 1 automatic success.` },
      { id: 'gold', name: 'Gold', dpCost: 3, stageRequirement: 'mega', effect: `[Weapon] attacks gain +4 Accuracy, +1 Damage. [Ranged] [Weapon] attacks gain +5 meters base range.` },
      { id: 'obsidian', name: 'Obsidian', dpCost: 3, stageRequirement: 'mega', effect: `[Weapon] attacks gain +2 Accuracy, +2 Damage, and +1 rank Armor Piercing.` },
      { id: 'red', name: 'Red', dpCost: 3, stageRequirement: 'mega', effect: `[Weapon] attacks gain +6 Damage.` },
    ],
  },
  ...
  // === BOSS QUALITIES ===
  // Reserved for NPC/enemy digimon. bossOnly: true gates these from player-partner digimon.
  ...
  // --- Static [S] ---
  {
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Gains stacking dodge bonus against attacks it has already seen.',
    effect: `The Digimon gains a stacking +2 bonus to dodging attacks that it has already seen for every time it has seen said Attack. That includes being in the blast of an [Area] Tagged Attack. Keep track of which Attacks the party has used as such.`,
  },
  {
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Swap which SPEC Value a quality or effect uses.',
    effect: `For each Rank of Alternative Energy that a Digimon takes, choose a Quality, Mechanic, or Effect Tag that the Digimon has access to. If that Quality or Effect Tag uses the Digimon's BIT Value, CPU Value, or RAM Value, it may now choose another Value to use in its place. Multipliers to said Values remain the same based on the Quality or Effect chosen.`,
  },
  {
    id: 'finesse',
    name: 'Finesse',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Ignore Armor points when attacking and Damage points when defending.',
    effect: `For each Rank a Digimon has in Finesse, they may ignore up to that many points of Armor when Attacking and that many points of Damage when being attacked. This is applied to all Attacks the Digimon has, and stacks with Armor Piercing Ranks.`,
  },
  {
    id: 'immunity',
    name: 'Immunity',
    ...
    prerequisites: ['Resistant Rank 3'],
    bossOnly: true,
    description: 'All Effects targeting this Digimon have no Duration or Potency.',
    effect: `Any Effects that would target this Digimon have no Duration or Potency.`,
  },
  {
    id: 'juggernaut',
    name: 'Juggernaut',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Each round, randomly gain +2 to a chosen stat (stacking).',
    effect: `At the beginning of each Round of Combat, choose a Stat randomly by rolling 1D6 (1: Health, 2: Accuracy, 3: Damage, 4: Dodge, 5: Armor, 6: Choose). The Digimon gains a +2 bonus to the Stat for the rest of Combat. This bonus stacks with each round.`,
  },
  {
    id: 'memory-upgrade',
    name: 'Memory Upgrade',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Gain an additional Attack per Rank.',
    effect: `For each Rank a Digimon has in Memory Upgrade, it gains an additional Attack that it can use. You must still choose whether the Attack is [Ranged] [Melee] [Damage], [Effect], or has any [Area] tags or otherwise as is normal when building an Attack on a Digimon.`,
  },
  {
    id: 'multigrappler',
    name: 'Multigrappler',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Clash with multiple enemies at once.',
    effect: `The Digimon is capable of Clashing with multiple enemies at once. If it also has the Reach Quality, it may Clash at Range with 1 target without taking any penalties.`,
  },
  {
    id: 'natural-warp-evolver',
    name: 'Natural Warp Evolver',
    type: 'purchasable',
    category: 'boss',
    qualityType: 'static',
    dpCost: 3,
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Evolve to highest form without Tamer assistance; stage-by-stage grants Jogress DP.',
    effect: `The Digimon may naturally Evolve straight to its highest form without any outside assistance from a Tamer, usually jumping from Rookie to Ultimate or higher, bypassing at least one stage. However, if the Digimon Evolves through its stages one at a time (Rookie → Champion → Ultimate → Mega → Ultra), it gains Bonus DP as if it had Jogressed (5 Bonus DP per Stage). If one stage past the In-Training Stage has Natural Warp Evolver, all Stages must sport this Quality, otherwise it has no effect.`,
  },
  {
    id: 'overclocked',
    name: 'Overclocked',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Derived Stats improve at Stage Bonus + full Stat (Rank 1) or ×2 Stat (Rank 2).',
    effect: `Rank 1: Each of the Digimon's Derived Stats improve at a rate equal to the Base Bonus plus a single Stat that would normally improve the Derived Stat (e.g. with Body you could choose Armor, Damage, or Health) instead of the normal formula. Brains improves at Stage Bonus+Accuracy instead of Accuracy/2.\nRank 2: Each of the Digimon's Derived Stats improve at a rate equal to the Base Bonus plus a single Stat times two.`,
  },
  {
    id: 'phasing',
    name: 'Phasing',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Move through solid objects; targets behind them gain RAM dodge bonus.',
    effect: `The Digimon gains the ability to move through solid objects and use [Melee] Attacks through them to hit whatever is on the other side. Solid objects are considered Difficult Terrain for movement, and targets gain a bonus to their Dodge equal to their RAM value to avoid Attacks through objects, as the user cannot fully see them.`,
  },
  {
    id: 'pure-rage',
    name: 'Pure Rage',
    ...
    prerequisites: ['Berserker'],
    bossOnly: true,
    description: 'Uncapped Rage Meter; also adds to Accuracy and Dodge.',
    effect: `The Digimon's Rage Meter no longer has a cap on how many points of Rage it may have at a time, and adds to the Digimon's Accuracy and Dodge as well instead of just Damage and Armor.`,
  },
  {
    id: 'skill-monkey',
    name: 'Skill Monkey',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Gain an additional Data Optimization or Specialization per Rank.',
    effect: `For each Rank the user has in Skill Monkey they may take an additional Data Optimization or Specialization. The Data Optimization or Specialization must still be purchased with DP the same way their first one was.`,
  },
  {
    id: 'spatial-distortion',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Ignore Range rules; Melee at any range, no Ranged distance penalties.',
    effect: `A Digimon with this Quality does not follow the rules of Range when making Attacks: it may make Melee Attacks at any range it wishes, and suffers no penalties for making Ranged Attacks due to distance. The Digimon still requires line of sight to hit the opponent.`,
  },
  {
    id: 'suppression',
    name: 'Suppression',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Suppress a chosen quality type ([S]/[T]/[A]) within Burst Radius.',
    effect: `For each Rank in this Quality, choose a type of Quality ([T]rigger, [S]tatic, or [A]ttack). Digimon within the Burst Radius of the user cannot benefit from or activate Qualities of the chosen type. Digimon in the radius may make a Brains check vs the user's Brains+2 to throw off the Suppression. Success: immune to Suppression for the rest of the encounter. Failure: Suppressed for the rest of the encounter and cannot roll again.`,
  },
  {
    id: 'true-sight',
    name: 'True Sight',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'See through solid objects; negates Phasing dodge bonus if also Phasing.',
    effect: `The Digimon gains the ability to see through solid objects. If the Digimon has Phasing, targets on the other side of a solid object no longer get a bonus to their Dodge.`,
  },
  {
    id: 'ultimate-force',
    name: 'Ultimate Force',
    ...
    stageRequirement: 'mega',
    bossOnly: true,
    description: 'Gain a single Rank of Digizoid Weaponry, Digizoid Armor, and Gain Force.',
    effect: `Prerequisite: Weapon Rank 1 or Instinct Rank 1 (GM discretion), Mega Level or higher. The Digimon has an understanding of what true power is and what it means to possess it. This Digimon may possess a single rank of the following qualities: Digizoid Weaponry, Digizoid Armor, and Gain Force.`,
  },
  {
    id: 'unlimited-power',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Purchase any Quality at base cost per Rank, no prerequisites required.',
    effect: `The Digimon may now purchase Qualities as if they all stated "X DP Per Rank", where X is the base cost of the Quality. This means that the Digimon may purchase Qualities over and over without regard to Rank. Additionally, the Digimon does not have to meet any prerequisites for Qualities.`,
  },

  // --- Trigger / Attack [T] / [T, A] ---
  {
    id: 'chain-counter',
    name: 'Chain Counter',
    type: 'purchasable',
    ...
    prerequisites: ['Counterattack'],
    bossOnly: true,
    description: 'Retain Counterattack/Counterblow use after KO-ing a player Digimon.',
    effect: `When the boss renders a Player Character Digimon unconscious through the use of Counterattack or Counterblow, they retain their use of either of the aforementioned qualities.`,
  },
  {
    id: 'mass-destruction',
    ...
    dpCost: 1,
    maxRanks: 1,
    prerequisites: ['Chain Counter'],
    bossOnly: true,
    description: 'Retain Counterattack/Counterblow use after destroying a summoned minion.',
    effect: `When the boss destroys a summoned minion through the use of Counterattack or Counterblow, they retain their use of either of the aforementioned qualities.`,
  },
  {
    id: 'data-absorb',
    name: 'Data Absorb',
    ...
    dpCost: 3,
    maxRanks: 1,
    prerequisites: ['Trojan'],
    bossOnly: true,
    description: 'Toggle: halt movement, heal BIT×2 per round (up to BIT×6 with extra actions).',
    effect: `As a Simple Action, a Digimon may activate or deactivate this Quality. While active, the Digimon's Movement Speed is reduced to 0, and the Digimon heals itself for BIT×2 at the end of each Round. The Digimon may increase this by forfeiting an extra Simple Action during its Turn (BIT×4, then BIT×6).`,
  },
  {
    id: 'disarm',
    name: 'Disarm',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Tag an Attack with [Disarm]; strip Weapon quality benefits on 2+ damage.',
    effect: `Choose an Attack. It now has the [Disarm] tag. If an Attack with the [Disarm] tag hits and deals at least 2 damage, the target no longer gets benefits from the Weapon Quality or associated Qualities (Digizoid Weaponry, etc.). It may still use those Attacks but without the Weapon benefits.`,
  },
  {
    id: 'gravity',
    name: 'Gravity',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Simple Action: impose [Gravity] in Burst Radius, disabling flight and Extra Movement.',
    effect: `As a Simple Action, the Boss may impose the [Gravity] effect. All afflicted Digimon within the attacker's Burst Radius lose access to their Extra Movement for as long as they remain within the Boss's Burst Radius. If Advanced Mobility of their preferred movement type was purchased, they lose that instead and keep Extra Movement. Digimon with Extra Movement: Flight or Wallclimber suffer damage as per falling rules and cannot fly/climb walls.`,
  },
  {
    id: 'omnipotent-summoning',
    name: 'Omnipotent Summoning',
    type: 'purchasable',
    category: 'boss',
    qualityType: 'trigger',
    dpCost: 3,
    maxRanks: 2,
    prerequisites: ['Summoner', 'Specialized Summoning'],
    bossOnly: true,
    description: 'Gain an additional Specialized Summoning type per Rank (all three at Rank 2).',
    effect: `For every rank, the Digimon may take another type of Specialized Summoning. At two ranks, they may have all three types described in Specialized Summoning. They cannot summon a super minion with the abilities of all three.`,
  },
  {
    id: 'smite',
    name: 'Smite',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Tagged attack deals half damage even on a miss.',
    effect: `If the Digimon would miss with an Attack with the [Smite] tag, it instead only deals half the Damage it would normally deal to the target(s).`,
  },
  {
    id: 'superior-domain',
    name: 'Superior Domain',
    type: 'purchasable',
    category: 'boss',
    qualityType: 'trigger',
    dpCost: 2,
    ...
    prerequisites: ['Element Master'],
    bossOnly: true,
    description: 'Apply two Domain effects simultaneously, or amplify a single Domain.',
    effect: `The Digimon is capable of applying two effects at the same time to their Domain Control. Alternatively, this Quality amplifies a singular taken Domain (which cannot be contested) as follows:\n• Treacherous Fire: Terrain is Difficult; those within Burst Radius suffer [Poison] for the full BIT Score.\n• Volatile Element: Full BIT score applies to [Exploit] (not halved).\n• Shadow Vale: Free [Sneak Attack] while in Domain (still requires Stealth roll vs Perception).\n• Sapping Strength: Start of round, roll 1d6 for up to BIT Score targets. On 5+, inflict [Lifesteal] siphoning 1 Wound Box. +1 passive bonus to roll.\n• Gusty Garden: [Knockback] counted as CPUx2; targets pushed to perimeter take 2 unalterable damage.\n• Cleansing Mist: All [Effects] except the Domain Controller's are invalid; Controller gains +1 Accuracy per negated Effect.\n• Rejuvenating Light: Controller immune to [Blind] and [Sneak Attack]; only Controller benefits from [Regenerate].\n• Thunder Justice: Start of round, roll 1d6 for up to BIT Score targets. On 5+, inflict [Paralysis] + equal Movement debuff for that turn. +1 passive per die. Cannot be affected by Huge Power or Overkill.\n• Natural Limitation: Only Boss-summoned Minions may exist; all foreign minions are immediately dispelled.\n• DG Dimension (v.2): Static check at the beginning gains +2 (capped at 6).`,
  },
  {
    id: 'time-control',
    name: 'Time Control',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Once per combat: negate a KO, restore Wound Boxes and spent qualities, then gain BIT bonus to all stats.',
    effect: `If the Digimon would be defeated due to Wound Boxes reaching 0, negate the effects of that attack and give the Digimon a number of additional Wound Boxes equal to their Stage Bonus. The Digimon also regains the use of all Qualities that can only be spent a certain number of times per Scene. After activation, this Quality cannot activate again until the next combat. The user gains a bonus to all stats equal to its BIT value for the rest of the fight.`,
  },
  {
    id: 'tormentor',
    name: 'Tormentor',
    ...
    prerequisites: [],
    bossOnly: true,
    description: 'Once per combat: force Torment Checks, gain +2 to all stats per failure.',
    effect: `The Digimon may force all participants who are able to make a Torment Check as a Simple Action once per combat. If an opponent fails the check, the Digimon gains a +2 bonus to all Stats for the remainder of the encounter. This bonus stacks with each failure, to a maximum of the number of participants that made a Torment Check.`,
  },
  {
    id: 'weapons-expert',
    name: 'Weapons Expert',
    ...
    dpCost: 3,
    maxRanks: 1,
    prerequisites: ['Weapon Rank 3'],
    bossOnly: true,
    exclusiveChoices: true,
    choices: [
      { id: 'bit', name: 'BIT', effect: 'Add BIT Value to damage and accuracy on Weapon attacks.' },
      { id: 'cpu', name: 'CPU', effect: 'Add CPU Value to damage and accuracy on Weapon attacks.' },
      { id: 'ram', name: 'RAM', effect: 'Add RAM Value to damage and accuracy on Weapon attacks.' },
    ],
    description: 'Add a chosen SPEC Value to [Weapon] attack damage and accuracy; unlimited Weapon Ranks.',
    effect: `Whenever the Digimon uses a [Weapon] tagged Attack, it may add a Value of its choice (CPU, RAM, or BIT) to the damage and accuracy dealt. Additionally, the Digimon may purchase as many Ranks of Weapon as it wishes, instead of just three.`,
  },
  ...
  // --- Boss Attack Effects [A] ---
  {
    ...
    prerequisites: [],
    bossOnly: true,
    description: '[N] Swap target\'s SPEC values: BIT→RAM, RAM→CPU, CPU→BIT.',
    effect: `Apply [Bug] tag to an attack. When a Digimon is afflicted with Bug, their SPEC values are swapped: BIT becomes RAM, RAM becomes CPU, CPU becomes BIT. Example: BIT 5 / CPU 4 / RAM 6 becomes BIT 4 / CPU 6 / RAM 5.`,
  },
  {
    id: 'effect-charm',
    name: 'Charm',
    ...
    prerequisites: [],
    bossOnly: true,
    description: '[N] Take control of the target\'s actions for the duration.',
    effect: `Apply [Charm] tag to an attack. The user takes control of the target's actions for the duration, costing 2 Simple Actions per round to maintain concentration. [Area] Attacks: only one target may be Charmed (Charmer chooses); Charmed target gains a blanket +2 to all stats. Controller may spend 1 action to force the Charmed target to Intercede for them. A target cannot be Charmed again by the same source after the effect ends. If the Charmed target is hit by the user's allies, Charm ends. The Charmed target is treated as same allegiance for Quality purposes. The target's Human Partner may contest with 3d6+Willpower or 3d6+Charisma (whichever is higher) vs the Digimon's Brains; success ends Charm. [Charm] does not remove [Overwrite] but allows control of Overwritten targets.`,
  },
  {
    ...
    prerequisites: [],
    bossOnly: true,
    description: '[N] Reduce a tamer\'s selected Attribute by 1; blocks associated Special Orders.',
    effect: `Apply [Demoralize] tag to an attack. Can only target humans. Deals no damage. The GM selects a Single Attribute to be targeted (the only value that may decrease for the encounter). When a Human is hit: the Tamer's selected Attribute decreases by 1 for the rest of the battle (minimum 1). If the human had Special Orders associated with that Attribute, they lose access to them. May only be used Once Per Round, even if the Boss has multiple spots on the initiative.`,
  },
  {
    id: 'effect-frenzy',
    name: 'Frenzy',
    ...
    prerequisites: [],
    bossOnly: true,
    description: '[N/A] Afflicted Digimon gains BIT½ damage but must attack each turn; random targeting on failed Charisma check.',
    effect: `Apply [Frenzy] tag to an attack. Afflicted Digimon gain a Damage Buff of BIT½ but can no longer be affected by most Directs or Special Orders (passive Special Orders still apply). The afflicted Digimon must make ONE attack every turn before the human can take actions. The human must make a Charisma Check vs the Digimon's Brains+Stage Bonus to direct the attack; on failure, the Digimon attacks a random target by rolling 1d[Turn Initiative Count]. Frenzy ends via [Tough it Out!], [Cleanse/Purify], or duration expiry. Maximum duration: 3 turns.`,
  },
  {
    ...
    prerequisites: [],
    bossOnly: true,
    description: '[N] Anti-armor attack; half Armor on hit, [Stun] if dealing 4+ damage. Available at 75%/50%/25% wound thresholds.',
    effect: `Apply [Tank Buster] tag to one Attack. Cannot be used at the beginning of combat; only usable when the Boss's Wound Box Pool reaches (at or below) 75%, 50%, and 25% thresholds. On use, the target's Armor is treated as halved. If the attack does more than 4 damage, it inflicts a secondary [Stun] effect. [Tank Buster] cannot be combined with: [Signature Move], [Counterattack], [Counterblow], [Hazard], [Armor Piercing], or [Certain Strike].`,
  },
]
