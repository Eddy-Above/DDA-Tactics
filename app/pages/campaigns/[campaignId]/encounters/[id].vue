...
function getAttackStats(participant: CombatParticipant, attack: any) {
  ...
  // Huge Power: Reroll 1s on Accuracy (Rank 2: also 2s)
...
function canUseHugePower(participant: CombatParticipant, attack: any): { rank1: boolean; rank2: boolean } {
  ...
  const currentRound = currentEncounter.value?.round || 0
...
<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div v-else-if="!currentEncounter" class="text-center py-12">
      ...
      <NuxtLink :to="`/campaigns/${campaignId}/encounters`" class="text-digimon-orange-400 hover:text-digimon-orange-300">
    ...
    <template v-else>
      ...
      <div class="flex justify-between items-start mb-6">
        <div>
          <NuxtLink :to="`/campaigns/${campaignId}/encounters`" class="text-digimon-dark-400 hover:text-white text-sm mb-2 inline-block">
