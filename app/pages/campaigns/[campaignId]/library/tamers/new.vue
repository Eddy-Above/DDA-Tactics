...
<template>
  <div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="mb-8">
      <NuxtLink :to="`/campaigns/${campaignId}/library/tamers`" class="text-digimon-dark-400 hover:text-white text-sm mb-2 inline-block">
        &larr; Back to Tamers
      </NuxtLink>
    ...
    <form class="space-y-8" @submit.prevent="handleSubmit">
      ...
      <div class="flex gap-4">
        ...
        <NuxtLink
          :to="`/campaigns/${campaignId}/library/tamers`"
