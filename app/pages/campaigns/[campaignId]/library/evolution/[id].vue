...
<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div v-else-if="!evolutionLine" class="text-center py-12">
      ...
      <NuxtLink :to="`/campaigns/${campaignId}/library/evolution`" class="text-digimon-orange-400 hover:text-digimon-orange-300">
    ...
    <template v-else>
      ...
      <div class="flex justify-between items-start mb-8">
        <div>
          <NuxtLink :to="`/campaigns/${campaignId}/library/evolution`" class="text-digimon-dark-400 hover:text-white text-sm mb-2 inline-block">
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div class="flex-1">
                    ...
                    <div v-if="getLinkedDigimon(entry)" class="mt-2 flex items-center gap-2">
                      ...
                      <NuxtLink
                        :to="`/campaigns/${campaignId}/library/digimon/${entry.digimonId}`"
